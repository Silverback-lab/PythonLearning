# Youtube video https://www.youtube.com/watch?v=VSQZl43jFzk&t=5s
...
# The print  down below me, just test that the Above is all Gucci
# print(people)
...
def change_person(person: Person):
    ...
    if len (person_list) > 0:
        ...
        return HTTPException(status_code=404, detail=f"Person with if {person.id} does not exist!")
